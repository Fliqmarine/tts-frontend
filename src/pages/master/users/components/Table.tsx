...
const roleChipSx = (role: string) => {
    const map: Record<string, { bg: string; fg: string }> = {
        SuperAdmin: { bg: "rgba(59,110,145,0.10)", fg: "#3B6E91" },
                        ...
                        {filteredUsers.map((user) => {
                            ...
                            return (
                                <TableRow
                                    ...
                                    selected={isSelected}
                                >
                                    <TableCell padding="checkbox" sx={{ pl: 1.5 }}><Checkbox size="small" color="primary" checked={isSelected} onChange={() => handleSelectRow(user.id)} /></TableCell>
                                    {/* Avatar + Name */}
                                    <TableCell>
                                        <Box
                                            sx={{
