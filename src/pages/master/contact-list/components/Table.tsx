            ...
            >
                <Table size="small">
                            ...
                            filtered.map((contact) => {
                                ...
                                return (
                                    <TableRow key={contact.id} selected={isSelected} hover>
                                        <TableCell padding="checkbox" sx={{ pl: 1.5 }}><Checkbox size="small" color="primary" checked={isSelected} onChange={() => handleSelectRow(contact.id)} /></TableCell>
                                        {/* Category / Group */}
                                        <TableCell>
                                            <Chip
                    ...
                    {filtered.length > 0 && (
                        <TableFooter>
                            <TableRow>
                                <TableCell colSpan={9} sx={{ py: 1, borderBottom: 0, bgcolor: "action.hover" }}>
